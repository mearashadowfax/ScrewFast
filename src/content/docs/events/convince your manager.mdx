...
description: Explore CommerceQuest's template for convincing your manager to join a hackathon. 
sidebar:
...
Below is a copy-paste template suggestion that you can use. Of course the more you can personalize it and relate it to your company goals and challenges, the better!
