...
### Validate if your change actually worked:
 - After your commit, go to the [Actions tab](https://github.com/spryker-community/spryker-community.github.io/actions) and click on the latest action that has the name of your commit.
 - While the website is rebuilding, the status will be orange. Once it's green, you can check the changes on the [live site](https://site.commercequest.space/).
