...
- Go to [/src/content/docs](https://github.com/spryker-community/spryker-community.github.io/tree/main/src/content/docs) and select the folder (category) that fits your new article best;
...
- Go to [/src/content/docs](https://github.com/spryker-community/spryker-community.github.io/tree/main/src/content/docs) and create a new folder (these act as categories);
...
#### Upload the image
- Go to [/src/images](https://github.com/spryker-community/spryker-community.github.io/tree/main/src/images) and on the top right click "Add file" > "Upload files"
