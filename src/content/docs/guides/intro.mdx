...
\
  ...
  <Card title="Oryx" icon="star">
    A framework empowering developers to build composable frontends with ease by providing a rich library of components, which lets developers create modern and visually appealing UI.\
   ...
   <Card title="Propel" icon="star">
    A highly customizable and blazing fast ORM library for PHP8.\
